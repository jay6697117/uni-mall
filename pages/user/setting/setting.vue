    ...
    <view class="content">
      <view class="list">
        <view class="row">
          ...
          <view class="right"
            ><view class="tis">
              <image src="/static/img/face.jpg" mode="widthFix"></image> </view
        ...
        <view class="row">
          ...
          <view class="right"
            ><view class="tis">大黑哥</view><view class="icon jiantou"></view
          ></view>
        </view>
        <view class="row">
        ...
        <view class="row">
          ...
          <view class="right"
            ><view class="tis"></view><view class="icon jiantou"></view
          ></view>
        </view>
        <view class="row">
      ...
      <view class="list">
        <view class="row">
          ...
          <view class="right"
            ><view class="tis">v1.0.0</view><view class="icon jiantou"></view
          ></view>
        </view>
        <view class="row">
